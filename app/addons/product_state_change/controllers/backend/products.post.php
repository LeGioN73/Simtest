...
if ($mode == 'manage') {
    ...
    $selected_fields[] = array('name' => '[data][product_state]', 'text' =>	__('product_state'));
    ...
    $product_state = fn_get_schema('product_state', 'state');
    unset($product_state['common']);

    if (!empty($selected_fields['data']['product_state'])) {
